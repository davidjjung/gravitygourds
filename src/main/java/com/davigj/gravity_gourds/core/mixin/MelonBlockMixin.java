...
public abstract class MelonBlockMixin extends StemGrownBlock implements Fallable {
    public MelonBlockMixin(Properties p_57058_) {
        super(p_57058_);
    }

    public void onLand(Level level, BlockPos pos, BlockState state, BlockState state2, FallingBlockEntity falling) {
    }
